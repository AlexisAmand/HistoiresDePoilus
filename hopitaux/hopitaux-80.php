...
<div class="container">
    ...
    <section class="row">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les hôpitaux de la Somme</li>
        </ol>
        </nav>

        <h1 class="my-4">Les hôpitaux de la Somme pendant la Grande Guerre</h1>
		...
		<figure class="text-center">
			...
			<img src="miniatures/hopital-mixte-amiens.jpeg" class="figure-img img-fluid img-thumbnail" alt="L'hôpital mixte installé à l'Hôtel Dieu d'Amiens"></a>
		...
		<figure class="text-center">
			...
			<img src="miniatures/breuil-ht-36.jpg" class="figure-img img-fluid img-thumbnail" alt="Hôpital temporaire n°36 de Breuil-le-Sec"></a>
			<figcaption class="figure-caption">Hôpital temporaire n°36</figcaption>
		</figure>

		<h2>Sources et bibliographie</h2>

		<ul>
			<li>Archives d'électricité médicale n°422 (novembre 1917)</li>
		</ul>
