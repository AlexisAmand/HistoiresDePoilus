                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="hopitaux.php">Le système de santé pendant la Grande Guerre</a>
                                <a class="dropdown-item" href="hopitaux-59.php">Les hôpitaux du Nord</a>
                                <a class="dropdown-item" href="hopitaux-62.php">Les hôpitaux du Pas-de-Calais</a>
                                <a class="dropdown-item" href="hopitaux-80.php">Les hôpitaux de la Marne</a>
                            </div>
                        </li>
                        <li class="nav-item">
