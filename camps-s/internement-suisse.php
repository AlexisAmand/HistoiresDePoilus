...
<div class="container">
    ...
    <section class="row">
        ...
        <li class="breadcrumb-item"><a href="index.php" title="Retour à la page d'accueil">Accueil</a></li>
            <li class="breadcrumb-item"><a href="../camps-nl/camps-internements.php" title="Les camps d'internement aux Pays-Bas pendant la Grande Guerre">Les camps d'internement</a></li>
