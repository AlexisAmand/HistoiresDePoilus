...
<ul>
	<li class="PuissancesAlliees">En vert, les puissances alliées</li>
...
<br/>
    ...
    <table class="tab_camp">
        ...
        <tr>
            <td headers="noname" class="PuissancesCentrales">Autriche-Hongrie</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Belgique</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesCentrales">Bulgarie</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesCentrales">Empire Allemand</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Empire Russe</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">États-Unis</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">France (+ Colonies)</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Grèce</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Italie</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Japon</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Monténégro</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Portugal</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Roumanie</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Royaume-Uni (+ Empire)</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesAlliees">Serbie</td>
        ...
        <tr>
            <td headers="noname" class="PuissancesCentrales">Turquie</td>
        ...
        <tr>
            ...
            <td headers="mobilises">73 799 000</td>
            <td headers="tues">9 405 315</td>
            <td headers="blesses">21 219 152</td>
            <td headers="prisonniers">7 613 145</td>
        </tr>
    </table>

<p class="sources">
<?php setlocale(LC_ALL,'french'); echo "Dernière modification effectuée le ".date("j F Y", getlastmod()); ?> 
</p>
