...
<head>
	...
	<title>Dossier d'ancien combattant de Druon Joseph CARLIER - Histoires de Poilus</title>
    <meta content="Version numérisée du dossier d'ancien combattant du soldat Druon Joseph CARLIER obtenu aux archives départementales du Nord" name="description">
...
<div class="container">
    ...
    <section class="row">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="../webographie.php" title=" ">Les dossiers d'anciens combattants</a></li>
            <li class="breadcrumb-item active" aria-current="page">CARLIER Druon Joseph</li>
        </ol>
        </nav>

        <h1 class="my-4">Le dossier de CARLIER Druon Joseph</h1>
            ...
            <div class="MultiCarousel" data-items="3,3,5,8" data-slide="3" id="MultiCarousel"  data-interval="1000">
                <div class="MultiCarousel-inner">
                    ...
                    for ($i = 1;$i<= 12;$i++)
                        ...
                        echo '<img src="images/CARLIER_Druon_Joseph/page_'.$i.'.jpg" alt="Extrait du dossier d\'ancien combattant de Druon CARLIER" class="img-thumbnail"';
                        echo 'onclick="document.getElementById(\'imageGal\').src=\'images/CARLIER_Druon_Joseph/page_'.$i.'.jpg\';
                        document.getElementById(\'imageGal2\').href=\'images/CARLIER_Druon_Joseph/page_'.$i.'.jpg\';"/>';
                        echo '</div></div>';
                        }
                    ?>
        ...
        <figure class="text-center">
        	<a href="images/CARLIER_Druon_Joseph/page_1.jpg" id="imageGal2" data-fancybox="gallery" data-caption=" ">
        	<img src="images/CARLIER_Druon_Joseph/page_1.jpg" id="imageGal" alt="extrait du dossier d'ancien combattant de CARLIER Druon" class="figure-img img-fluid img-thumbnail"/></a>
        	<figcaption class="figure-caption">Dossier d'ancien combattant de Druon CARLIER<br />
