...
<head>
    ...
    <title>Dossier d'ancien combattant de Florimond LETIENNE - Histoires de Poilus</title>
    <meta content="Version numérisée du dossier d'ancien combattant du soldat Florimond LETIENNE obtenu aux archives départementales du Nord" name="description">
...
<div class="container">
    ...
    <section class="row">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">LETIENNE Florimond</li>
        </ol>
        </nav>

        <h1 class="my-4">Le dossier de LETIENNE Florimond</h1>
            ...
            <div class="MultiCarousel" data-items="3,3,5,8" data-slide="3" id="MultiCarousel"  data-interval="1000">
                <div class="MultiCarousel-inner">
                    ...
                    for ($i = 1;$i<= 9;$i++)
                        ...
                        echo '<img src="images/LETIENNE_Florimond/page_'.$i.'.jpg" alt="Extrait du dossier d\'ancien combattant de Florimond LETIENNE" class="img-thumbnail"';
                        echo 'onclick="document.getElementById(\'imageGal\').src=\'images/LETIENNE_Florimond/page_'.$i.'.jpg\';
                        document.getElementById(\'imageGal2\').href=\'images/LETIENNE_Florimond/page_'.$i.'.jpg\';"/>';
                        echo '</div></div>';
                        }
                    ?>
        ...
        <figure class="text-center">
        	<a href="images/LETIENNE_Florimond/page_1.jpg" id="imageGal2" data-fancybox="gallery" data-caption=" ">
        	<img src="images/LETIENNE_Florimond/page_1.jpg" id="imageGal" alt="extrait du dossier d'ancien combattant de LETIENNE Florimond" class="figure-img img-fluid img-thumbnail"/></a>
        	<figcaption class="figure-caption">Dossier d'ancien combattant de LETIENNE Florimond<br />
