...
<head>
    ...
    <meta content="Version numérisée du dossier d'ancien combattant du soldat Louis Abraham CARLIER obtenu aux archives départementales du Nord" name="description">
...
<div class="container">
    ...
    <section class="row">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">CARLIER Louis Abraham</li>
        </ol>
        </nav>

        <h1 class="my-4">Le dossier de CARLIER Louis Abraham</h1>
        ...
        <figure class="text-center">
        	<a href="images/CARLIER_Louis_Abraham/page_1.jpg" id="imageGal2" data-fancybox="gallery" data-caption=" ">
        	<img src="images/CARLIER_Louis_Abraham/page_1.jpg" id="imageGal" alt="extrait du dossier d'ancien combattant de CARLIER Louis" class="figure-img img-fluid img-thumbnail"/></a>
        	<figcaption class="figure-caption">Dossier d'ancien combattant de CARLIER Louis Abraham<br />
