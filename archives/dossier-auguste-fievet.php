...
<div class="container">
    ...
    <section class="row">
            ...
            <div class="MultiCarousel" data-items="3,3,5,8" data-slide="3" id="MultiCarousel"  data-interval="1000">
                <div class="MultiCarousel-inner">
                    ...
                    for ($i = 1;$i<= 13;$i++)
                        ...
                        echo '<img src="images/FIEVET_Auguste _Victor/page_'.$i.'.jpg" alt=" " class="img-thumbnail"';
                        echo 'onclick="document.getElementById(\'testgal\').src=\'images/FIEVET_Auguste _Victor/page_'.$i.'.jpg\';
                        document.getElementById(\'testgal2\').href=\'images/FIEVET_Auguste _Victor/page_'.$i.'.jpg\';"/>';
                        echo '</div></div>';
                        }
                    ?>
        ...
        <figure class="text-center">
        	<a href="images/FIEVET_Auguste _Victor/page_1.jpg" id="testgal2" data-fancybox="gallery" data-caption=" ">
        	<img src="images/FIEVET_Auguste _Victor/page_1.jpg" id="testgal" alt="extrait du dossier d'ancien combattant de FIEVET Auguste Victor" class="figure-img img-fluid img-thumbnail"/></a>
