...
<head>
    ...
    <title>Dossier d'ancien combattant de Louis TIBURCE - Histoires de Poilus</title>
    <meta content="Version numérisée du dossier d'ancien combattant du soldat Louis TIBURCE obtenu aux archives départementales du Nord" name="description">
...
<div class="container">
    ...
    <section class="row">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">TIBURCE Louis</li>
        </ol>
        </nav>

        <h1 class="my-4">Le dossier de TIBURCE Louis</h1>
            ...
            <div class="MultiCarousel" data-items="3,3,5,8" data-slide="3" id="MultiCarousel"  data-interval="1000">
                <div class="MultiCarousel-inner">
                    ...
                    for ($i = 1;$i<= 20;$i++)
                        ...
                        echo 'onclick="document.getElementById(\'testgal\').src=\'images/TIBURCE_Louis/page_'.$i.'.jpg\';
                        document.getElementById(\'testgal2\').href=\'images/TIBURCE_Louis/page_'.$i.'.jpg\';"/>';
                        echo '</div></div>';
                        }
                    ?>
        ...
        <figure class="text-center">
        	<a href="images/TIBURCE_Louis/page_1.jpg" id="testgal2" data-fancybox="gallery" data-caption=" ">
        	<img src="images/TIBURCE_Louis/page_1.jpg" id="testgal" alt="extrait du dossier d'ancien combattant de TIBURCE Louis" class="figure-img img-fluid img-thumbnail"/></a>
        	<figcaption class="figure-caption">Dossier d'ancien combattant de TIBURCE Louis<br />
