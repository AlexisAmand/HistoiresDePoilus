...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les prisonniers</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Les camps de prisonniers en Allemagne</h1>
        ...
        <figure class="text-center">
            ...
            <img src="camps/miniatures/camps-prisonniers-allemagne.jpg" class="figure-img img-fluid img-thumbnail" alt="carte des camps de prisonniers allemands pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Localisation des camps de prisonniers en Allemagne<br />(Cliquez pour agrandir)<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="camps/miniatures/friedrichsfeld-prisonniers-français.jpg" class="figure-img img-fluid img-thumbnail"  alt="Des prisonniers français au camp de Friedrichsfeld"/></a>
            <figcaption class="figure-caption">Des prisonniers au camp de Friedrichsfeld (Allemagne)<br />(cliquez pour agrandir)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            <img src="images/la-haye-01.jpg" class="figure-img img-fluid img-thumbnail" alt="La Première Conférence de La Haye en 1899"/>
            <figcaption class="figure-caption">La Première Conférence de La Haye en 1899</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="camps/miniatures/allemand.jpg" class="figure-img img-fluid img-thumbnail" alt="Des prisonniers allemands à Toulouse pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Des prisonniers allemands à Toulouse<br />(cliquez pour agrandir)</figcaption>
        </figure>
