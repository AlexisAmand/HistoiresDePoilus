...
<head>
    ...
    <meta content="Parcours et biographie du poilu Jules MAGNY, soldat français pendant la Première Guerre Mondiale" name="description"/>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Jules MAGNY</li>
        </ol>
    </nav>
    ...
    <p class="text-justify"><strong>Jules MAGNY</strong>, né le 18 août 1892 à Onnaing (Nord), il est le fils légitime de Jules MAGNY et Adna Marie HERAT.</p>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/magny-jules-1892.jpg" class="figure-img img-fluid img-thumbnail" alt="Acte de naissance de Jules MAGNY, né à Onnaing en 1892"/></a>
            <figcaption class="figure-caption">Acte de naissance de Jules MAGNY (1892)<br />(source: Archives Départementales du Nord)</figcaption>
        </figure>
