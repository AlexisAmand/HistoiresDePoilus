...
<head>
    ...
    <title>Biographie et parcours du soldat FIEVET Auguste Victor - Histoires de Poilus</title>
...
<div class="container">
    ...
    <p class="text-justify"><strong>Auguste Victor FIEVET</strong> est né à Lille (Nord) le 8 janvier 1890. Il est le fils légitime de Charles Jules FIEVET, fileur de coton, âgé de 28 ans et de Marie Roseline LOHIEZ, âgée de 19 ans. Il a pour frère <a href="FIEVET-Charles-Augustin.php" title="Biographie du soldat Charles Augustin FIEVET">Charles Augustin</a>.</p>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/FIEVET-Auguste-Victor.jpg" class="figure-img img-fluid img-thumbnail" alt="portrait d'Auguste Victor FIEVET"/></a>
            <figcaption class="figure-caption">Portrait d'Auguste Victor FIEVET<br />(source: Archives Départementales du Nord)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/gare-arras-1914.JPG" class="figure-img img-fluid img-thumbnail" alt="L'intérieur de la gare d'Arras vers 1914-1915 sur une carte postale ancienne"/></a>
            <figcaption class="figure-caption">L'intérieur de la gare d'Arras en 1914-1915<br />(Source: Wikipedia Commons) </figcaption>
        </figure>
        ...
        <figure class="text-center"> 
            ...
            <img src="miniatures/Von_Emmich.jpg" class="figure-img img-fluid img-thumbnail" alt="portrait du général allemand Von Emmich"/></a>
            <figcaption class="figure-caption">Le Général Von Emmich<br />(Source: Wikipedia Commons) </figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Dinant-1914.jpg" class="figure-img img-fluid img-thumbnail"  alt="La citadelle de Dinant au début de 1914 sur une carte postale ancienne"/></a>
            <figcaption class="figure-caption">La Citadelle de Dinant, début 1914<br />(source: Gallica/BNF)</figcaption> 
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/dinant_detruite_1914.jpg" class="figure-img img-fluid img-thumbnail"  alt="La ville de Dinant après les combats d'août 1914"/></a>
            <figcaption class="figure-caption">Dinant détruite en 1914</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/carte-dinant.jpg" class="figure-img img-fluid img-thumbnail" alt="Localisation de la ferme du Rond Chêne sur une carte de Dinant et ses environs"/></a>
            <figcaption class="figure-caption">La ferme du Rond Chêne sur une carte de Dinant<br />(cliquez pour agrandir)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/hopitaux-nantes.jpg" class="figure-img img-fluid img-thumbnail" alt="Liste des hôpitaux de Nantes pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Les hôpitaux de Nantes<br />(source: Archives Municipales de Nantes)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/fav-matricule-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Extrait de la fiche matricule d'Auguste Victor FIEVET"/></a>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/carte-auguste-fievet.jpg" class="figure-img img-fluid img-thumbnail"  alt="Carte d'ancien combattant d'Auguste FIEVET"></a>
            <figcaption class="figure-caption">Carte d'ancien combattant ayant appartenu à Auguste<br />(source: Archives Départementales du Nord)</figcaption> 
        </figure>

        <h2>Sources et bibliographie</h2>

        <ul>
            <li><a href="../archives/dossier-auguste-fievet.php" title="version numérisée du dossier d'ancien combattant d'Auguste FIEVET" target="_blank">
