...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Gaston ARNOULD</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Gaston ARNOULD</h1>
        ...
        <figure class="text-center">
            <a href="images/matricule-gaston-arnould.jpg" data-fancybox="gallery" data-caption="Le signalement de Gaston Alexandre ARNOULD">
            <img src="miniatures/matricule-gaston-arnould.jpg"  class="figure-img img-fluid img-thumbnail" alt="Le signalement de Gaston Alexandre ARNOULD sur un extrait de sa fiche matricule"></a>
            <figcaption class="figure-caption">Son signalement sur sa fiche matricule<br />
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/port-brillet-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Vue général et l'usine Chappée à Port-Brillet sur une carte postale de 1931"></a>
            <figcaption class="figure-caption">Port-Brillet vers 1931 (Mayenne)<br />
            Vue générale du bourg, à droite l’Usine Chappée<br />
            (source : Archives départementales de la Mayenne)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/port-brillet-02.jpg" data-fancybox="gallery" data-caption="L'intérieur des Usines de Port-Brillet">
            <img src="miniatures/port-brillet-02.jpg" class="figure-img img-fluid img-thumbnail" alt="L'intérieur des Usines de Port-Brillet sur une carte postale ancienne"></a>
            <figcaption class="figure-caption">Port-Brillet (Mayenne)<br />
            intérieur des Usines Chappée<br />
            (source : Archives départementales de la Mayenne)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/bleriot-XI.jpg" class="figure-img img-fluid img-thumbnail" alt="Un avion Blériot XI exposé de Musée de la RAF à Hendon"></a>
            <figcaption class="figure-caption">Un Blériot XI au Musée de la RAF à Hendon<br />
