...
<div class="container">
    ...
    <h1 class="my-4">Firmin MICHEL</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/arbre-michel.png" class="figure-img img-fluid img-thumbnail" alt="Arbre généalogique simplifié de la famille MICHEL" class="ArbreGenealogique"/></a>
            <figcaption class="figure-caption">Arbre simplifié de la famille MICHEL<br />(cliquez pour agrandir)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Max_von_Hausen.jpg" class="figure-img img-fluid img-thumbnail" alt="portrait du Baron Max Von Hausen"/></a>
            <figcaption class="figure-caption">Max Von Hausen<br />(Source: Wikipedia Commons)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/MICHEL-Firmin-mpf.jpg" class="figure-img img-fluid img-thumbnail" alt="Fiche de mort pour la France de Firmin MICHEL"/></a>
            <figcaption class="figure-caption">Firmin, mort pour la France<br />(Source: Mémoire des Hommes)</figcaption>
        </figure>
       ...
       <p class="text-justify">Sa fiche, retrouvée sur le site "Mémoire des Hommes", nous apprend qu'il dépendait du bureau de Reims (Marne) pour son recrutement et que son acte de décès a été retranscrit sur l'état civil de Betheniville (Marne), où son nom figure sur le Monument aux Morts. <strong>Firmin</strong> repose aujourd'hui à la Nécropole Nationale de Bras-sur-Meuse (Tombe 50) </p>
        ...
        <figure class="text-center">
            ...
            <img src="../tombes/images/mini/betheniville-monument-aux-morts.jpg" class="figure-img img-fluid img-thumbnail" alt="le Monument aux Morts de Bétheniville sur une carte postale ancienne"/></a>
            <figcaption class="figure-caption">Le Monument du Souvenir (guerre 1914-1918)<br />(Source: Delcampe)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Saint-Hilaire-ww1-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Un canon anti-poux à Saint-Hilaire-le-Petit pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Un canon anti-poux à Saint-Hilaire-le-Petit<br />(Source: Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Saint-Hilaire-ww1-02.jpg" data-fancybox="gallery" data-caption="Les allemands à Saint-Hilaire-le-Petit">
            <img src="miniatures/Saint-Hilaire-ww1-02.jpg" class="figure-img img-fluid img-thumbnail" alt="Les allemands dans une rue de Saint-Hilaire-le-Petit"/></a>
            <figcaption class="figure-caption">Les allemands à Saint-Hilaire-le-Petit<br />(Source: Delcampe)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Saint-Hilaire-ww1-03.jpg" class="figure-img img-fluid img-thumbnail" alt="Les allemands préparant le pain pour le déjeuner à Saint-Hilaire-le-Petit"/></a>
            <figcaption class="figure-caption">Préparations du pain pour le déjeuner<br />(Source: Delcampe)</figcaption>
        </figure>
