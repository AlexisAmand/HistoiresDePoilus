...
<head>
    ...
    <title>Biographie et parcours du soldat CARLIER Druon Joseph - Histoires de Poilus</title>
    <meta content="Parcours de Druon Joseph CARLIER, soldat sebourgeois pendant la Première Guerre Mondiale. Il était membre du 2e Régiment d'Infanterie Territoriale puis prisonnier de guerre à Friedrichsfeld" name="description">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Druon Joseph CARLIER</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Druon Joseph CARLIER</h1>
      ...
      <ul>
          <li><a href="../archives/dossier-druon-carlier.php" title="version numérisée du dossier d'ancien combattant de Druon Joseph CARLIER" target="_blank">
          Le dossier d'ancien combattant de Druon Joseph CARLIER</a></li>
