...
<html lang="fr">
    ...
    <head>
        ...
        <meta content="Parcours de Alfred CARIN, soldat pendant la Première Guerre Mondiale" name="description">
    ...
    <ul>
        ...
        <li><a href="carin-alfred.php" class="AsideSelected">CARIN Alfred</a></li>
