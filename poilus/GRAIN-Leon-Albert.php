...
<head>
    ...
    <title>Biographie et parcours du soldat GRAIN Léon Albert - Histoires de Poilus</title>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Léon Albert GRAIN</li>
        </ol>
    </nav>
    ...
    <p class="text-justify">Frère de <a href="GRAIN-Louis.php" title="voir la page consacrée à Louis Grain">Louis</a>, <strong>Léon Albert GRAIN</strong> est né le vendredi 26 décembre 1879 à Villers-Guislain (Nord). Il est le fils légitime de Louis GRAIN, domestique âgé de 19 ans et Joséphine VELU, âgé de 17 ans. En 1906, Léon est tisseur et vit Rue du Catelet à Villers-Guislain en compagnie de son épouse Angèle BERCHON et de leur fille Lucie.</p>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Leon-grain-matricule-02.jpg" class="figure-img img-fluid img-thumbnail" alt="extrait de la fiche matricule de Léon Albert GRAIN"/></a>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Leon-grain-matricule-01.jpg" class="figure-img img-fluid img-thumbnail" alt="extrait de la fiche matricule de Léon Albert GRAIN"/></a>
            <figcaption class="figure-caption">Extrait de sa fiche matricule.<br />(source: Archives Départementales du Nord)</figcaption> 
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/camp-de-chemnitz.jpg" class="figure-img img-fluid img-thumbnail" alt="Le camp de prisonniers de Chemnitz sur une carte postale"/></a>
        ...
        <ul>   	
            <li><a href="http://archives.genealexis.fr/album/18-grain-leon" title="version numérisée du dossier d'ancien combattant de Léon Albert GRAIN" target="_blank">
            Le dossier d'ancien combattant de Léon Albert GRAIN</a></li>   
            ...
            <li><a href="../pdf/Maubeuge-1914-Duvivier.pdf" title="La Bataille de Maubeuge en septembre 1914" target="_blank">
            ...
            <li><a href="https://grandeguerre.icrc.org/" target="_blank" title=" ">
