...
<html lang="fr">
    ...
    <div id="pubaside">
        ...
        <p>A <a href="mobilisation-1914.php" Titre="Voir le décret de mobilisation générale de 1914">la mobilisation</a>, <strong>Alexandre</strong> est considéré comme appelé sous les drapeaux et maintenu à son emploi de temps de paix au titre des <strong>Sections de Chemins de Fer de Campagne</strong> du 2 août 1914 au 5 janvier 1919. Je sais que, pour de nombreux lecteurs, cette affectation ne fait pas de lui un poilu au sens strict du terme, car il n'était pas dans l'enfer de Verdun ou dans la boue des tranchées. Mais laissez-moi vous raconter la suite.</p>
