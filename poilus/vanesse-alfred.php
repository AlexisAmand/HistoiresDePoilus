...
<html lang="fr">
    ...
    <head>
        ...
        <meta content="Parcours de Alfred VANESSE pendant la Première Guerre Mondiale." name="description"/>
    ...
    <ul>
        ...
        <li><a href="vanesse-alfred.php" class="AsideSelected">VANESSE Alfred</a></li>
