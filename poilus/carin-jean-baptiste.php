...
<head>
    ...
    <meta content="Parcours de Jean Baptiste CARIN, soldat français pendant la Première Guerre Mondiale" name="description">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Jean-Baptiste CARIN</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Jean-Baptiste CARIN</h1>
        ...
        <ul>
            ...
            <li><a href="https://archivesdepartementales.lenord.fr/" title=" " target="_blank">
             Départementales du Nord</a></li>
            <li><a href="http://amzn.to/2rvOovF" title=" " target="_blank">
            Prisonniers 1914-1918</a> (Editions Sulton / Jean-Paul Briaste)</li>
            <li><a href="http://grandeguerre.icrc.org/fr" title="Comité international de la Croix-Rouge" target="_blank">
