...
<head>
    ...
    <title>Les camps d'internement aux Pays-Bas pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation des camps d'internement aux Pays-Bas pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../index.php">Accueil</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">Les Pays-Bas</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Les camps d'internement aux Pays-Bas</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/carte-camps-pb.png" class="figure-img img-fluid img-thumbnail" alt="Localisation des camps d'internés aux Pays-Bas pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Carte des camps d'internés aux Pays-Bas<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))<br />(cliquez pour agrandir)</figcaption>
        </figure>
