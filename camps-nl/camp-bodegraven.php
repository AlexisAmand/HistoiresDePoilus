...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../index.php">Accueil</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Bodegraven</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp d'internement de Bodegraven</h1>
        ...
        <figure class="text-center">
            <img src="miniatures/Bodegraven/fort-bodegraven.jpg" class="figure-img img-fluid img-thumbnail" alt="le fort de Bodegraven aux Pays-Bas de nos jours">
            <figcaption class="figure-caption">Le Fort de Bodegraven<br />(source: <a href="http://www.nieuwerbrug.net">http://www.nieuwerbrug.net</a>)</figcaption>
        </figure>
