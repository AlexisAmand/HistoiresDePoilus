...
<head>
    ...
    <title>Le camp d'internement de Assen aux Pays-Bas pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp d'internement de Assen aux Pays-Bas pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../index.php">Accueil</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Assen</li>
        </ol>
    </nav>

    <span onclick="fonctiontest();" id="asidebouton"><i class="fas fa-bars"></i>&nbsp;Afficher la liste des camps</span>

    <h1 class="my-4">Le camp d'internement de Assen</h1>

        <figure class="text-center">
            <a href="images/carte-camps-pb.png" data-fancybox="gallery" data-caption="Emplacement du camp d'internés d'Assen">
            <img src="miniatures/carte-camps-pb.png" class="figure-img img-fluid img-thumbnail" alt="Localisation du camp d'internés d'Assen pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Localisation du camp d'internés d'Assen (Pays-Bas)<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))<br />(cliquez pour agrandir)</figcaption>
        </figure>
