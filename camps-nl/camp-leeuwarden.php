...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../index.php">Accueil</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Leeuwarden</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp d'internement de Leeuwarden</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/carte-camps-pb.png" class="figure-img img-fluid img-thumbnail" alt="Localisation du camp d'internés de Leeuwarden pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Localisation du camp d'internés de Leeuwarden (Pays-Bas)<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))<br />(cliquez pour agrandir)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Leeuwarden/leeuwarden-01.jpg" data-fancybox="gallery" title="Un bout de toilette au camp de Leeuwarden">
            <img src="miniatures/Leeuwarden/leeuwarden-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Un bout de toilette au camp de Leeuwarden aux Pays-Bas"></a>
            <figcaption class="figure-caption">Un bout de toilette au camp de Leeuwarden<br />(source : Delcampe)</figcaption>
        </figure>
