...
<head>
    ...
    <title>Le camp d'internement de Harderwijk aux Pays-Bas pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp d'internement de Harderwijk aux Pays-Bas pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <h1 class="my-4">Le camp d'internement de Harderwijk</h1>

        <figure class="text-center">
            <a href="images/carte-camps-pb.png" data-fancybox="gallery" data-caption="Emplacement du camp d'internés de Harderwijk">
            <img src="miniatures/carte-camps-pb.png" class="figure-img img-fluid img-thumbnail" alt="Localisation du camp d'internés de Harderwijk pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Localisation du camp d'internés d'Harderwijk (Pays-Bas)<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))<br />(cliquez pour agrandir)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Harderwijk/harderwijk-01.jpg" data-fancybox="gallery" data-caption="Le camp de Harderwijk aux Pays-Bas">
            <img src="miniatures/Harderwijk/harderwijk-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Une cantine du camp d'internement de Harderwijk aux Pays-Bas pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">Une cantine à Harderwijk<br />(source : Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Harderwijk/harderwijk-02.jpg" data-fancybox="gallery" data-caption="Le camp de Harderwijk aux Pays-Bas">
            <img src="miniatures/Harderwijk/harderwijk-02.jpg" class="figure-img img-fluid img-thumbnail" alt="Le camp d'internement d'Harderwijk aux Pays-Bas pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Le camp de Harderwijk<br />(source : Delcampe)</figcaption>
        </figure class="text-center">

        <figure class="text-center">
            <a href="images/Harderwijk/harderwijk-03.jpg" data-fancybox="gallery" data-caption="Le camp de Harderwijk aux Pays-Bas">
            <img src="miniatures/Harderwijk/harderwijk-03.jpg" class="figure-img img-fluid img-thumbnail" alt="Le camp d'internement d'Harderwijk aux Pays-Bas pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">Le camp de Harderwijk<br />(source : Delcampe)</figcaption>
        </figure class="text-center">

        <figure class="text-center">
            <a href="images/Harderwijk/harderwijk-04.jpg" data-fancybox="gallery"  title="Le camp de Harderwijk aux Pays-Bas">
            <img src="miniatures/Harderwijk/harderwijk-04.jpg" class="figure-img img-fluid img-thumbnail" alt="Salle de billards des soldats du camps d'internement aux Pays-Bas d'Harderwijk pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">La salle de billards des soldats<br />(source : Delcampe)</figcaption>
        </figure>
