...
<head>
    ...
    <title>Le camp d'internement de Amersfoort aux Pays-Bas pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp d'internement de Amersfoort aux Pays-Bas pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Amersfoort</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp d'internement d'Amersfoort</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/carte-camps-pb.png" class="figure-img img-fluid img-thumbnail"  alt="Localisation du camp d'internés d'Amersfoort pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Localisation du camp d'internés d'Amersfoort (Pays-Bas)<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))<br />(cliquez pour agrandir)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Amersfoort/amersfoort-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Le camp d'internement d'Amersfoort aux Pays-Bas pendant la Première Guerre Mondiale"></a>
