...
<head>
    ...
    <title>Le camp d'internement de Zeist aux Pays-Bas pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp d'internement de Zeist aux Pays-Bas pendant la Première Guerre mondiale (1914-1918)">
                      ...
                      <ul class="navbar-nav mx-auto">
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                  ...
                                  <a class="dropdown-item" href="camps-internements.php">Les camps d'internement aux Pays-Bas</a>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="../index.php">Accueil</a></li>
            <li class="breadcrumb-item"><a href="camps-internements.php">Les camps d'internement</a></li>
            <li class="breadcrumb-item active" aria-current="page">Le camp de Zeist</li>
        </ol>
    </nav>

    <span onclick="fonctiontest();" id="asidebouton"><i class="fas fa-bars"></i>&nbsp;Afficher la liste des camps</span>

    <h1 class="my-4">Le camp d'internement de Zeist</h1>

        <figure class="text-center">
            <a href="images/carte-camps-pb.png" data-fancybox="gallery" data-caption="Emplacement du camp d'internés de Zeist">
            <img src="miniatures/carte-camps-pb.png" class="figure-img img-fluid img-thumbnail" alt="Localisation du camp d'internés de Zeist pendant la Première Guerre Mondiale"/></a>
            <figcaption class="figure-caption">Localisation du camp d'internés de Zeist (Pays-Bas)<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))<br />(cliquez pour agrandir)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Zeist/zeist-01.jpg" data-fancybox="gallery" data-caption="Le camp de Zeist pendant la Grande Guerre">
            <img src="miniatures/Zeist/zeist-01.jpg" class="figure-img img-fluid img-thumbnail" alt="L'heure du bain au camp d'internement de Ziest aux Pays-Bas pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">L'heure du bain<br />(source : Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Zeist/zeist-02.jpg" data-fancybox="gallery"  title="Le camp de Zeist pendant la Grande Guerre">
            <img src="miniatures/Zeist/zeist-02.jpg" class="figure-img img-fluid img-thumbnail" alt="En route pour la corvée au camp d'internement de Ziest aux Pays-Bas pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Fourrager la viande et en route pour la corvée<br />(source : Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Zeist/zeist-03.jpg" data-fancybox="gallery"  title="Le camp de Zeist pendant la Grande Guerre">
            <img src="miniatures/Zeist/zeist-03.jpg" class="figure-img img-fluid img-thumbnail" alt="Fêtes sportives à l'occasion de l'anniversaire au camp d'internement de Zeist aux Pays-Bas pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Fêtes sportives à l'occasion de l'anniversaire<br />De sa Majesté le Roi Albert I (8 avril 1916)<br />(source : Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Zeist/zeist-04.jpg" data-fancybox="gallery"  title="Le camp de Zeist pendant la Grande Guerre">
            <img src="miniatures/Zeist/zeist-04.jpg" class="figure-img img-fluid img-thumbnail" alt="Le retour de la promenade Fêtes au camp d'internement de Ziest aux Pays-Bas pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Le retour de la promenade<br />(source : Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Zeist/zeist-05.jpg" data-fancybox="gallery"  title="Le camp de Zeist pendant la Grande Guerre">
            <img src="miniatures/Zeist/zeist-05.jpg" class="figure-img img-fluid img-thumbnail" alt="Le chemin principal du camp d'internement de Ziest aux Pays-Bas pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Le chemin principal du camp I<br />Carte postale)</figcaption>
        </figure>
