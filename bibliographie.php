...
<head>
    ...
    <title>Ressources bibliographiques sur la Première Guerre Mondiale - Histoires de Poilus</title>
    <meta name="description" content="Selection de livres pour retracer le parcours militaire de vos ancêtres poilus pendant la Première Guerre Mondiale">
...
<div class="container">
    ...
    <section class="row">
        ...
        <ol class="breadcrumb">
          ...
          <p class="text-justify">Vous trouverez sur cette page la liste de toutes les ressources bibliographiques (livres et revues par exemple) qui m'ont permis de réaliser mes recherches sur la Première Guerre Mondiale. J'ai essayé d'être le plus exhaustif possible, mais n'hésitez pas à <a href="#contactModal" data-toggle="modal" data-target="#contactModal">me contacter</a> si vous avez une question ou un renseignement. Je vous invite à cliquer sur les titres (quand c'est possible), cela vous mènera directement à la source. Peut-être trouverez vous aussi des infos sur vos ancêtres ayant participé à la Première Guerre Mondiale ?</p>
