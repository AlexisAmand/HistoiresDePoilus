...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les tombes de Beaufort</li>
        </ol>
    </nav>

    <span onclick="afficheMenu();" id="asidebouton"><i class="fas fa-bars"></i>&nbsp;Afficher la liste des villes</span>

    <h1 class="my-4">Le monument aux morts de Beaufort</h1>

        <figure class="text-center">
            <a href="images/monument-beaufort-01.jpg" data-fancybox="gallery" data-caption="Le monument aux Morts de Beaufort (Nord)">
            <img src="images/mini/monument-beaufort-01.jpg" class="figure-img img-fluid img-thumbnail" alt="le Monument aux Morts pour la France de Beaufort dans l'Avesnois"/></a>
            <figcaption class="figure-caption">Le monument aux morts de Beaufort<br />(Source: Photo privée)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="images/mini/monument-beaufort-02.jpg" class="figure-img img-fluid img-thumbnail" alt="La plaque hommage aux victimes de 39-45 du monument aux Morts pour la France de Beaufort dans l'Avesnois"/></a>
            <figcaption class="figure-caption">La plaque hommage aux victimes de 39-45<br />(Source: Photo privée)</figcaption>
        </figure>
