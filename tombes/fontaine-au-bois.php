...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les tombes de Fontaine-au-Bois</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Les monuments de Fontaine-au-Bois</h1>
        ...
        <figure class="text-center">
            ...
            <img src="images/mini/Fontaine-au-Bois-02.jpg" class="figure-img img-fluid img-thumbnail" alt="Le monument aux morts pour la France de la commune de Fontaine-au-Bois"/></a>
            <figcaption class="figure-caption">Le monument aux Morts pour la France <br />de Fontaine-au-Bois<br />(Source: Photo privée)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Fontaine-au-Bois-03.jpg" data-fancybox="gallery" data-caption="Le monument aux morts de Fontaine-au-Bois">
            <img src="images/mini/Fontaine-au-Bois-03.jpg" class="figure-img img-fluid img-thumbnail" alt="Le monument aux morts pour la France de la commune de Fontaine-au-Bois"/></a>
            <figcaption class="figure-caption">Le monument aux Morts pour la France <br />de Fontaine-au-Bois<br />(Source: Photo privée)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="images/mini/Fontaine-au-Bois-01.jpg" class="figure-img img-fluid img-thumbnail" alt="La croix de la section britannique du cimetière communal de Fontaine-au-Bois"/></a>
            <figcaption class="figure-caption">La croix de la section britannique<br />du cimetière communal <br />(Source: Photo privée)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="images/mini/Cross-Roads-Cemetery.jpg" class="figure-img img-fluid img-thumbnail" alt="Le cimetière britannique Cross Roads Cemetery à Fontaine-au-bois"/></a>
            <figcaption class="figure-caption">Le Cross Roads Cemetery <br />de Fontaine-au-Bois<br />(Source: Wikipedia Commons)</figcaption>
        </figure>
