...
<header class="row">
	...
	<div  class="col-md-6 text-center">
		...
		<img src="images/logo.png" class="logo img-fluid" alt="Histoires de Poilus" /></a>
    ...
    <div  class="col-md-6 text-right">
        ...
        <img src="images/facebook.png" class="mx-1 my-2"/>
        </a>
        <a href="#" title="#"> 
        <img src="images/googleplus.png" class="mx-1 my-2"/>
        </a>
	    <a href="https://twitter.com/alexisamand?lang=fr" title="Me suivre sur Twitter">
        <img src="images/twitter.png" class="mx-1 my-2"/>
        </a>
