...
<html lang="fr">
    ...
    <ul>
        ...
        <li><a href="camp-wahn.php" class="AsideSelected">Wahn</a></li>
    ...
    <div id="pubaside">
        ...
        <figure>
            ...
            <figcaption>Prisonniers alliés en Allemagne<br/>(source: CT)</figcaption>
        </figure>
        ...
        <figure>
            ...
            <figcaption>Construction de tentes<br/>(source: CT)</figcaption>
        </figure>
        ...
        <figure>
            ...
            <figcaption>Le repas du midi<br/>(source: CT)</figcaption>
        </figure>
