...
<head>
    ...
    <title>Le camp de prisonniers de Amberg pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp de prisonniers de Amberg en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Amberg</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Amberg</h1>
        ...
        <ul>
            ...
            <li><a href="https://gallica.bnf.fr/ark:/12148/btv1b10315936v" title=" " target="_blank">
