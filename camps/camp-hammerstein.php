...
<head>
    ...
    <title>Le camp de prisonniers de Hammerstein - Histoires de Poilus</title>
    <meta name="description" content="Présentation du camp de prisonniers de Hammerstein en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Hammerstein</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Hammerstein</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Hammerstein/hammerstein-01.jpg" class="figure-img img-fluid img-thumbnail" alt="le camp de prisonniers d'Hammerstein dans un ouvrage allemand paru pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">La queue pour le repas<br />(source allemande)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Hammerstein/hammerstein-02.jpg" data-fancybox="gallery" data-caption="Le camp de Hammerstein">
            <img src="miniatures/Hammerstein/hammerstein-02.jpg" class="figure-img img-fluid img-thumbnail" alt="le camp de prisonniers d'Hammerstein dans un ouvrage allemand paru pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Des russes préparant leur thé<br />(source allemande)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Hammerstein/hammerstein-03.jpg" data-fancybox="gallery" data-caption="Le camp de Hammerstein">
            <img src="miniatures/Hammerstein/hammerstein-03.jpg" class="figure-img img-fluid img-thumbnail" alt="le camp de prisonniers d'Hammerstein dans un ouvrage allemand paru pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Le repas pascal des prisonniers israélites<br />(source allemande)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Hammerstein/hammerstein-04.jpg" data-fancybox="gallery" data-caption="Le camp de Hammerstein">
            <img src="miniatures/Hammerstein/hammerstein-04.jpg" class="figure-img img-fluid img-thumbnail" alt="le camp de prisonniers d'Hammerstein dans un ouvrage allemand paru pendant la Première Guerre Mondiale"></a>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Hammerstein/hammerstein-05.jpg" class="figure-img img-fluid img-thumbnail" alt="le camp de prisonniers d'Hammerstein dans un ouvrage allemand paru pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Couple sibérien en soldat russe<br />(source allemande)</figcaption>
        </figure>
