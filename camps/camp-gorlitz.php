...
<head>
    ...
    <title>Le camp de prisonniers de Görlitz pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp de prisonniers de Görlitz pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Görlitz</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de Görlitz</h1>
        ...
        <figure class="text-center">
            <img src="miniatures/Gorlitz/gorlitz-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Des prisonniers du camp de Görlitz en rang pour la photographie">
            <figcaption class="figure-caption">En rang pour la photographie<br />(source allemande)</figcaption>
        </figure>
