...
<head>
    ...
    <title>Le camp de prisonniers de Gmünd pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp de prisonniers de Gmünd en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Gmund</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Gmünd</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Gmund/carte-camp-gmund.jpg" class="figure-img img-fluid img-thumbnail" alt="Localisation du camp de prisonniers de Gmünd"></a>
            <figcaption class="figure-caption">Localisation du camp de Gmünd<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Gmund/camp-gmund-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Enterrement d'un prisonnier français décédé au camp de Gmünd"></a>
            <figcaption class="figure-caption">Enterrement d'un prisonnier français décédé à Gmünd<br />(source: Clio Team)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Gmund/camp-gmund-02.jpg" data-fancybox="gallery" data-caption="Prisonniers français à Gmünd">
            <img src="miniatures/Gmund/camp-gmund-02.jpg" class="figure-img img-fluid img-thumbnail" alt="un groupe de prisonniers français au camp de Gmünd"></a>
            <figcaption class="figure-caption">Prisonniers français à Gmünd<br />(source: Clio Team)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Gmund/camp-gmund-03.jpg" data-fancybox="gallery" data-caption="Prisonniers français à Gmünd">
            <img src="miniatures/Gmund/camp-gmund-03.jpg" class="figure-img img-fluid img-thumbnail" alt="un groupe de prisonniers français au camp de Gmünd"></a>
            <figcaption class="figure-caption">Prisonniers français à Gmünd<br />(source: Clio Team)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Gmund/camp-gmund-04.jpg" data-fancybox="gallery" data-caption="Prisonniers français à Gmünd">
            <img src="miniatures/Gmund/camp-gmund-04.jpg" class="figure-img img-fluid img-thumbnail" alt="un groupe de prisonniers français au camp de Gmünd"></a>
            <figcaption class="figure-caption">Prisonniers français à Gmünd<br />(source: Clio Team)</figcaption>
        </figure>
