...
<head>
    ...
    <title>Le camp de prisonniers de Guben pendant la Grande Guerre - Histoires de Poilus</title>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Guben</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Guben</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Guben/guben-01.jpg" class="figure-img img-fluid img-thumbnail" alt="des prisonniers dans le camp de Guben pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">Au camp de prisonniers</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Guben/guben-02.jpg" data-fancybox="gallery" data-caption="Le camp de prisonniers de Guben">
            <img src="miniatures/Guben/guben-02.jpg" class="figure-img img-fluid img-thumbnail" alt="des gardes du camps de prisonniers de Guben reçoivent leurs mots d'ordre pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Les gardes reçoivent le mot d'ordre</figcaption>
        </figure>
