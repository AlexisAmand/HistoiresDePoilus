...
<head>
    ...
    <title>Le camp de prisonniers de Cassel pendant la Grande Guerre - Histoires de Poilus</title>
        <meta name="description" content="Présentation du camp de prisonniers de Cassel en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Cassel</li>
        </ol>
    </nav>

    <span onclick="afficheMenu();" id="asidebouton"><i class="fas fa-bars"></i>&nbsp;Afficher la liste des camps</span>

    <h1 class="my-4">Le camp de prisonniers de Cassel </h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Cassel/plan-cassel.jpg" class="figure-img img-fluid img-thumbnail" alt="Plan du camp de prisonniers de Cassel pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Plan du camp de Cassel<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))</figcaption>
        </figure>
        ...
        <ul>
            ...
            <li><a href="../pdf/globe-58-1919.pdf" title="Tome 58 du GLobe, la Revue genevoise de géographie" target="_blank">
