...
<head>
    ...
    <title>Le camp de prisonniers de Bayreuth pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp de prisonniers de Bayreuth en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <h1 class="my-4">Le camp de prisonniers de Bayreuth</h1>
        ...
        <figure class="text-center">
            ...
            <figcaption class="figure-caption">Localisation du camp de Bayreuth<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>
