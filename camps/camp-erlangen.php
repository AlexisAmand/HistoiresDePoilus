...
<head>
    ...
    <title>Le camp de prisonniers de Erlangen pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp de prisonniers de Erlangen en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp d'Erlangen</li>
        </ol>
    </nav>

    <span onclick="afficheMenu();" id="asidebouton"><i class="fas fa-bars"></i>&nbsp;Afficher la liste des camps</span>

    <h1 class="my-4">Le camp de prisonniers d'Erlangen</h1>

    <p class="text-justify">En septembre 1916, le Bulletin du Bureau de Secours de Berne indique qu'au camp d'Erlangen, un instituteur français donne des cours de français à des gradés russes et un employé du camp donne des cours d'allemand à des gradés français. (source : Selon le Bulletin du Bureau de Secours de Berne et L'intermède du 24 septembre 1916)</p>
