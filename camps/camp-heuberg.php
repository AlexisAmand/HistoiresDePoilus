...
<head>
    ...
    <title>Le camp de prisonniers de Heuberg pendant la Grande Guerre - Histoires de Poilus</title>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Heuberg</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Heuberg</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Heuberg/localisation-heuberg.jpg" class="figure-img img-fluid img-thumbnail" alt="carte de l'Allemagne pour localiser le camp de prisonniers de Heuberg"></a>
            <figcaption class="figure-caption">Localisation du camp de Heuberg<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Heuberg/Heuberg-01.jpg" data-fancybox="gallery" data-caption="L'arrivée des prisonniers à Heuberg">
            <img src="miniatures/Heuberg/Heuberg-01.jpg" class="figure-img img-fluid img-thumbnail" alt="l'arrivée des prisonniers au camp de Heuberg pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">L'arrivée au camp<br />(source allemande)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Heuberg/theatre.jpg" class="figure-img img-fluid img-thumbnail" alt="Théâtre improvisé par les prisonniers au camp de Heuberg"></a>   
            <figcaption class="figure-caption">Théâtre improvisé par les prisonniers</figcaption>
        </figure>
