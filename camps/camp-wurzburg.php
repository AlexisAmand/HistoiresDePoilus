...
<head>
    ...
    <title>Le camp de prisonniers de Würzburg pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description"  content="Présentation du camp de prisonniers de Würzburg en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Würzburg</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Würzburg</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Wurzburg/localisation-wurzburg.jpg" class="figure-img img-fluid img-thumbnail" alt="carte de l'Allemagne pour localiser le camp de prisonniers de Würzburg"></a>
            <figcaption class="figure-caption">Localisation du camp de Würzburg<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/wurzburg-01.png" class="figure-img img-fluid img-thumbnail" alt="les lavabos dans le camp de prisonniers de Würzburg pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">La salle des lavabos<br />(source allemande)</figcaption>
        </figure>
