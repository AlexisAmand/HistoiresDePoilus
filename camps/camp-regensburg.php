...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Ratisbonne</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Ratisbonne</h1>
        ...
        <figure class="text-center">    
            ...
            <img src="miniatures/Regensburg/camp-regensburg.jpg" class="figure-img img-fluid img-thumbnail" alt="carte de l'Allemagne pour localiser le camp de prisonniers de Ratisbonne (Regensburg)"></a>
            <figcaption class="figure-caption">Localisation du camp de Ratisbonne (Regensburg)<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>    
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Regensburg/regensburg-01.jpg" class="figure-img img-fluid img-thumbnail" alt="des prisonniers dans la cours du camp de Ratisbonne (Regensburg) pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Dans la cours du camp<br />(Source allemande)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Regensburg/regensburg-02.jpg" data-fancybox="gallery" data-caption="Vue du camp de Ratisbonne (Regensburg)">    
            <img src="miniatures/Regensburg/regensburg-02.jpg" class="figure-img img-fluid img-thumbnail" class="figure-img img-fluid img-thumbnail" alt="une vue du camp de prisonniers de Ratisbonne (Regensburg) pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">Vue du camp de Ratisbonne (Regensburg)<br />(Source allemande)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Regensburg/regensburg-03.jpg" class="figure-img img-fluid img-thumbnail" alt="Exercice des pompiers dans le camp de prisonniers de Ratisbonne (Regensburg) pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Exercice des pompiers<br />(Source allemande)</figcaption>
        </figure>
