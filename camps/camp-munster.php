...
<html lang="fr">
    ...
    <div id="pubaside">
        ...
        <table class="tab_camp">
            ...
            <thead>
            <tr>
                <th id="nations">Nationalités</th>
                <th id="effectifs">Effectifs au camp</th>
            </tr>
            </thead>
            <tr>
                <td headers="nations">Français</td>
                <td headers="effectifs">799</td>
            </tr>
            <tr>
                <td headers="nations">Belges</td>
                <td headers="effectifs">64</td>
            </tr>
            <tr>
                <td headers="nations">Portugais</td>
                <td headers="effectifs">20</td>
            </tr>
            <tr>
                <td headers="nations">Serbes</td>
                <td headers="effectifs">3</td>
            </tr>
            <tr>
                <td headers="nations">Russes</td>
                <td headers="effectifs">374</td>
            </tr>
            <tr>
                <td headers="nations">Anglais</td>
                <td headers="effectifs">527</td>
            </tr>
            <tr>
                <td headers="nations">Italiens</td>
                <td headers="effectifs">107</td>
            </tr>
            <tr>
                <td>Total</td>
                <td>1894</td>
        ...
        <table class="tab_camp">
            ...
            <tr>
                <td headers="nations">Français</td>
                <td headers="effectifs">2716</td>
            </tr>
            <tr>
                <td headers="nations">Belges</td>
                <td headers="effectifs">262</td>
            </tr>
            <tr>
                <td headers="nations">portugais</td>
                <td headers="effectifs">173</td>
            </tr>
            <tr>
                <td headers="nations">Serbes</td>
                <td headers="effectifs">18</td>
            </tr>
            <tr>
                <td headers="nations">Roumains</td>
                <td headers="effectifs">13</td>
            </tr>
        </table>
