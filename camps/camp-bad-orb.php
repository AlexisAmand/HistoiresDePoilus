...
<head>
    ...
    <title>Le camp de prisonniers de Bad Orb pendant la Grande Guerre - Histoires de Poilus</title>
...
<div class="container">
    ...
    <h1 class="my-4">Le camp de prisonniers de Bad Orb</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Bad-Orb/carte-camp-bad-orb.jpg" class="figure-img img-fluid img-thumbnail" alt="carte de l'Allemagne pour localiser le camp de prisonniers de Bad Orb"></a>
            <figcaption class="figure-caption">Localisation du camp de Bad Orb<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Bad-Orb/bad-orb-01.jpg" data-fancybox="gallery" data-caption="Le camp de Bad-Orb">
            <img src="miniatures/Bad-Orb/bad-orb-01.jpg" class="figure-img img-fluid img-thumbnail" alt="arrivée de prisonniers français au camp de Bad Orb pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Arrivée de prisonniers français (vers 1915)<br />(source allemande)</figcaption>
        </figure>
