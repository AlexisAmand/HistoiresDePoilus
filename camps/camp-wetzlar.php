...
<div class="container">
    ...
    <h1 class="my-4">Le camp de prisonniers de Wetzlar</h1>
        ...
        <p class="text-justify">Fin 1915, des prisonniers du camp de Wetzlar sont évacués vers les camps de <a href="camp-giessen.php">Giessen</a>, <a href="camp-limburg.php" title="Le camp de prisonniers de Limburg">Limburg</a>, Holzminden, <a href="camp-meschede.php" title="Le camp de prisonniers de Meschede">Meschede</a>, Stendal et <a href="camp-darmstadt.php" title="Le camp de prisonniers de Darmstadt">Darmstadt</a>. Le commandant du camp de Wetzlar fait savoir que les colis destinés aux prisonniers évacués sur les camps ci-dessus, suivront le destinataire: Quant aux colis qui ne porteront l'adresse d'aucun bénéficiaire nommément désigné, ils seront attribués aux prisonniers français du camp de Giessen.</p>
