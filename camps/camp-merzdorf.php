...
<head>
    ...
    <title>Le camp de prisonniers de Merzdorf pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description" content="Présentation du camp de prisonniers de Merzdorf  en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Merzdorf</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Merzdorf</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Merzdorf/plan-merzdorf.jpg" class="figure-img img-fluid img-thumbnail" alt="Plan du camp de prisonniers de Merzdorf pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Plan du camp de Merzdorf<br />(Le Globe, Revue genevoise de géographie, tome 58 (1919))</figcaption>
        </figure>
