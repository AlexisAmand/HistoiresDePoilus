...
<head>
    ...
    <title>Le camp de prisonniers de Lechfeld pendant la Grande Guerre - Histoires de Poilus</title>
    <meta name="description" content="Présentation du camp de prisonniers de Lechfeld en Allemagne pendant la Première Guerre mondiale (1914-1918)">
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Lechfeld</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de prisonniers de Lechfeld</h1>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Lechfeld/localisation-lechfeld.jpg" class="figure-img img-fluid img-thumbnail" alt="carte de l'Allemagne pour localiser le camp de prisonniers de Lechfeld"></a>
            <figcaption class="figure-caption">Localisation du camp de Lechfeld<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>


        <figure class="text-center">
            <a href="images/Lechfeld-cpa-02.jpg" data-fancybox="gallery" data-caption="Des prisonniers français à Lechfeld">
            <img src="miniatures/Lechfeld-cpa-02.jpg" class="figure-img img-fluid img-thumbnail" alt="Des prisonniers français dans le camp de prisonniers de Lechfeld pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">Des prisonniers français dans le camp de Lechfeld<br />(source : Delcampe)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Lechfeld-cpa-03.jpg" data-fancybox="gallery" data-caption="Des prisonniers français à Lechfeld">
            <img src="miniatures/Lechfeld-cpa-03.jpg" class="figure-img img-fluid img-thumbnail" alt="Des prisonniers français dans le camp de prisonniers de Lechfeld pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Des prisonniers français dans le camp de Lechfeld<br />(source : Delcampe)</figcaption>
        </figure>
