...
<head>
    ...
    <title>Le camp de prisonniers de Friedberg pendant la Grande Guerre - Histoires de Poilus</title>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Friedberg</li>
        </ol>
    </nav>

    <span onclick="afficheMenu();" id="asidebouton"><i class="fas fa-bars"></i>&nbsp;Afficher la liste des camps</span>

    <h1 class="my-4">Le camp de prisonniers de Friedberg</h1>

        <p class="text-justify"><em><strong>Mise en garde:</strong> Certaines photographies portent la mention "source allemande", cela signifie qu'elles sont issues d'ouvrages ou d'archives allemandes et qu'elles ne sont donc pas très objectives.</em></p><br /><p class="text-justify">Le « Rapports des Délégués du Gouvernement Espagnol sur leurs visites dans les camps de prisonniers français en Allemagne » indique que vers la fin de l'année 1917, tous les prisonniers ont été transférés au camp d'Eutin.</p>

        <figure class="text-center">
            <a href="images/Friedberg/friedberg-01.jpg" data-fancybox="gallery" data-caption="Le camp de prisonniers de Friedberg">
            <img src="miniatures/Friedberg/friedberg-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Appel des ordonnances des officiers russes dans le camp de Friedberg pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Appel des ordonnances des officiers russes (vers 1915)<br />(source allemande)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Friedberg/friedberg-02.jpg" data-fancybox="gallery" data-caption="Le camp de prisonniers de Friedberg">
            <img src="miniatures/Friedberg/friedberg-02.jpg" class="figure-img img-fluid img-thumbnail" alt="La cantine et la Kommandantur du camp de prisonniers de Friedberg"></a>
            <figcaption class="figure-caption">La cantine et la Kommandantur<br />(source : Delcampe)</figcaption>
        </figure>
        ...
        <ul>
            ...
            <li><a href="https://amzn.to/2MQhDQ7" target="_blank"  title="Livre sur les prisonniers de guerre dans l'histoire">
