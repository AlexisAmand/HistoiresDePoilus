...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Le camp de Zerbst</li>
        </ol>
    </nav>
    ...
    <h1 class="my-4">Le camp de Zerbst</h1>
        ...
        <figure class="text-center">    
            ...
            <img src="miniatures/Zerbst/localisation-zerbst.jpg" class="figure-img img-fluid img-thumbnail" alt="carte de l'Allemagne pour localiser le camp de prisonniers de Zerbst"></a>
            <figcaption class="figure-caption">Localisation du camp de Zerbst<br />(source pour le fond de carte: BNF - Gallica)</figcaption>
        </figure>  
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Zerbst/zerbst-01.jpg" class="figure-img img-fluid img-thumbnail" alt="Vue du camp de prisonniers de Zerbst pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">Vue du camp de Zerbst<br />(source allemande)</figcaption>
        </figure>

        <figure class="text-center">
            <a href="images/Zerbst/zerbst-02.jpg" data-fancybox="gallery" data-caption="Une cérémonie au camp de Zerbst">
            <img src="miniatures/Zerbst/zerbst-02.jpg" class="figure-img img-fluid img-thumbnail" alt="Une cérémonie au camp de prisonnier de Zerbst pendant la Première Guerre Mondiale"></a>
            <figcaption class="figure-caption">Une cérémonie au camp de Zerbst<br />(source : Delcampe)</figcaption>
        </figure>
        ...
        <figure class="text-center">
            ...
            <img src="miniatures/Zerbst/poilus-zerbst.jpg" class="figure-img img-fluid img-thumbnail" alt="Un prisonnier de guerre au camp de Zerbst pendant la Grande Guerre"></a>
            <figcaption class="figure-caption">(source : Françoise C.)</figcaption>
        </figure>
        ...
        <ul>
            ...
            <li><a href="http://amzn.to/2uBK1k3" target="_blank" title="Le livre prisonniers 1914-1918 par Jean-Paul Briastre">
