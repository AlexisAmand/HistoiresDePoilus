...
<header class="row" style="background-color: #364046;height: 175px;">
    ...
    AncienCombattant("TIBURCE_Louis",20);
    ...
    <h1 class="my-4">Dossier d'ancien combattant de Louis TIBURCE</h1>

    <?php /* TODO : SEO */ ?>

    <figure>
        <a href="images/TIBURCE_Louis/page_1.jpg" id="testgal2" data-fancybox="gallery" data-caption="Dossier d'ancien combattant du soldat Louis TIBURCE">
        <img src="images/TIBURCE_Louis/page_1.jpg" id="testgal" alt="Extrait du dossier d'ancien combattant de Louis TIBURCE" style="width:80%"/></a>
        <figcaption>Dossier d'ancien combattant de Louis TIBURCE<br />(Source: <a href="https://www.geneachtimi.com/">Généachtimi</a> et <a href="https://archivesdepartementales.lenord.fr/">Archives du Nord</a>)</figcaption>
    </figure>
