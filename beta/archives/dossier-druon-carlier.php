...
<header class="row" style="background-color: #364046;height: 175px;">
    ...
    <h1 class="my-4">Dossier d'ancien combattant de Druon Joseph CARLIER</h1>

    <?php /* TODO : SEO */ ?>

    <figure>
        <a href="images/CARLIER_Druon_Joseph/page_1.jpg" id="testgal2" data-fancybox="gallery" data-caption="Dossier d'ancien combattant du soldat Druon Joseph CARLIER">
        <img src="images/CARLIER_Druon_Joseph/page_1.jpg" id="testgal" alt="Extrait du dossier d'ancien combattant de Duron Joseph CARLIER" style="width:80%"/></a>
        <figcaption>Dossier d'ancien combattant de Druon Joseph CARLIER<br />(Source: <a href="https://www.geneachtimi.com/">Généachtimi</a> et <a href="https://archivesdepartementales.lenord.fr/">Archives du Nord</a>)</figcaption>
    </figure>
