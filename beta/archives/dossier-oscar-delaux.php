...
<header class="row" style="background-color: #364046;height: 175px;">
    ...
    AncienCombattant("DELAUX_Oscar",12);
    ...
    <h1 class="my-4">Dossier d'ancien combattant d'Oscar DELAUX</h1>

    <?php /* TODO : SEO */ ?>

    <figure>
        <a href="images/DELAUX_Oscar/page_1.jpg" id="testgal2" data-fancybox="gallery" data-caption="Dossier d'ancien combattant du soldat Oscar DELAUX">
