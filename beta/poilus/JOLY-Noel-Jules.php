...
<header class="row" style="background-color: #364046;height: 175px;">
    ...
    <?php include ('../include/pub.inc'); ?>
        ...
        <p class="text-justify">Pour la petite histoire, Lucia CARLIER (fille de <a href="CARLIER-Druon-Joseph.php" title="lien vers la page consacrée à Druon Carlier">Druon CARLIER</a>) épouse Noël JOLY (le fils de <a href="JOLY-Noel-Jules.php">Noël Jules JOLY) </a>le 24 septembre 1927 à Onnaing. </p>
