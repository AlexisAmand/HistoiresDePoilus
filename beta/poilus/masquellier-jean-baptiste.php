...
<header class="row" style="background-color: #364046;height: 175px;">
    ...
    <ul>
       ...
       <li><a href="carin-alfred.php">CARIN Alfred</a></li>
        ...
        <li><a href="masquellier-jean-baptiste.php" class="AsideSelected">MASQUELLIER Jean-Baptiste</a></li>     
    ...
    <?php include ('../include/pub.inc'); ?>
        ...
        <figure>
            ...
            <img src="miniatures/masquellier-naissance-1883.jpg" alt="Acte de naissance de Jean-Baptiste MASQUELLIER à Denain le 16 mars 1883"/></a>
