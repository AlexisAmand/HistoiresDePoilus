...
<header class="row" style="background-color: #364046;height: 175px;">
    ...
    <?php include ('../include/pub.inc'); ?>
        ...
        <h1 class="my-4">Oscar Julien DELAUX</h1>
        ...
        <ul>
            ...
            <li><a href="archives/dossier-oscar-delaux.php" title="version numérisée du dossier d'ancien combattant d'Oscar DELAUX">Le dossier d'ancien combattant d'Oscar DELAUX</a> (Archives Départementales du Nord)</li>
        </ul>
