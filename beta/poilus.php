...
<header class="row">
    ...
    <div  class="col-md-6 text-right">
        ...
        <img src="images/facebook.png" style="margin:5px 5px 5px 5px;"/>
        </a>
        <a href="#" title="#"> 
        <img src="images/googleplus.png" style="margin:5px 5px 5px 5px;"/>
        </a>
	    <a href="https://twitter.com/alexisamand?lang=fr" title="Me suivre sur Twitter">
        <img src="images/twitter.png"  style="margin:5px 5px 5px 5px;"/>
        </a>
	...
	<div  class="col-md-12">
		...
		<nav class="navbar navbar-expand-lg navbar-light">
		    ...
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item" >
		        <a class="nav-link NavSelected" href="#">Les Poilus</a>
		      </li>
		      <li class="nav-item">
...
<h3>Le bilan de la Grande Guerre</h3>
