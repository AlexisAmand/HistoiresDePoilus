...
<html lang="fr">
    ...
    <head>
        ...
        <title>Relevé des morts pour la France d'Onnaing - Histoires de Poilus</title>
        <meta content="relevés des soldats et des civils d'Onnaing morts pour la France pendant la Première Guerre Mondiale (1914-1918) d'après les monuments et les livres d'or">
    ...
    <ul>   
        ...
        <li class="asideheader">Nord</li>
	        ...
	        <li><a href="onnaing.php" class="AsideSelected">Onnaing</a></li>    
    ...
    <h1>Relevé des morts pour la France à Onnaing</h1>

    <p>(Relevé en cours)</p>

    <p>Voici la liste des morts pour la France et des victimes civiles d'Onnaing (Nord) au cours de la Première Guerre Mondiale. Je mettrai cette page à jour en fonction de mes découvertes. N'hésitez pas à me faire part de vos remarques ou à signaler les éventuelles erreurs en me laissant <a href="../contact.php">un petit commentaire</a>.</p>
