...
<title>Relevé des morts pour la France de Bry - Histoires de Poilus</title>
<meta content="relevés des soldats et des civils de Bry morts pour la France pendant la Première Guerre Mondiale (1914-1918) d'après les monuments et les livres d'or">
...
<script>
  d<?php include('../include/resp.inc'); ?>ument.addEventListener('DOMContentLoaded', function(event) {
...
<li><a href="bry.php"  class="AsideSelected">Bry</a></li>
