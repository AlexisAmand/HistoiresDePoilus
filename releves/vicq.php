<?php 
/* TODO : continuer le relevé de Vicq */ 
?>
...
<html lang="fr">
    ...
    <head>
        ...
        <title>Relevé des morts pour la France de Vicq (Nord) - Histoires de Poilus</title>
        <meta content="relevés des soldats et des civils de Vicq (Nord) morts pour la France pendant la Première Guerre Mondiale (1914-1918) d'après les monuments et les livres d'or">
    ...
    <ul>   
        ...
        <li class="asideheader">Nord</li>
	        ...
	        <li><a href="vicq.php" class="AsideSelected">Vicq</a></li>
    ...
    <div id="pubaside">
        ...
        <h1>Relevé des morts pour la France à Vicq</h1>

        <p>Voici la liste des morts pour la France de Vicq (Nord) au cours de la Première Guerre Mondiale. Je mettrai cette page à jour en fonction de mes découvertes. N'hésitez pas à me faire part de vos remarques ou à signaler les éventuelles erreurs en me laissant <a href="../contact.php">un petit commentaire</a>.</p>

        <figure>
            <a href="images/monument-vicq.jpg" data-fancybox="gallery" data-caption="Le Monument aux Morts de Vicq">
            <img src="images/mini/monument-vicq.jpg" alt="le Monument aux Morts de Vicq et la Rue Basse sur une carte postale ancienne"/></a>
            <figcaption>Le Monument et la Rue Basse<br>(source : Delcampe)</figcaption>
        </figure>
