...
<html lang="fr">
    ...
    <head>
        ...
        <title>Relevé des morts pour la France de Frencq - Histoires de Poilus</title>
        <meta content="relevés des soldats et des civils de Frencq (Pas-de-Calais) morts pour la France pendant la Première Guerre Mondiale (1914-1918) d'après les monuments et les livres d'or">
    ...
    <ul>   
        ...
        <li class="asideheader">Pas-de-Calais</li>
        	<li><a href="frencq.php" class="AsideSelected">Frencq</a></li>      	       
    ...
    <div id="pubaside">
        ...
        <h1>Relevé des morts pour la France à Frencq</h1>
